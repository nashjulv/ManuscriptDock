...
- Chinese name: `投稿舱`
- Current prerelease display version: `V0.60`
...
- Show the prerelease version immediately after the product name on primary identity surfaces: `投稿舱 ManuscriptDock V0.60`.
...
- Keep package and installer metadata SemVer-compatible (`V0.60` maps to `0.60.0`).
...
- The primary product identity intentionally remains bilingual as `投稿舱 ManuscriptDock V0.60`; do not remove either name as an internationalization cleanup.
