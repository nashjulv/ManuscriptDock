...
- Chinese name: `投稿舱`
- Current prerelease display version: `V0.45`
- Category: local-first manuscript submission workspace
- Desktop stack: Tauri 2.x, React 18, TypeScript 5, Vite 5, Rust/Cargo

## Versioning

- Show the prerelease version immediately after the product name on primary identity surfaces: `投稿舱 ManuscriptDock V0.45`.
...
- Keep package and installer metadata SemVer-compatible (`V0.45` maps to `0.45.0`).
...
- The primary product identity intentionally remains bilingual as `投稿舱 ManuscriptDock V0.45`; do not remove either name as an internationalization cleanup.
