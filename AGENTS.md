...
- Chinese name: `投稿舱`
- Current prerelease display version: `V0.22`
- Category: local-first manuscript submission workspace
- Desktop stack: Tauri 2.x, React 18, TypeScript 5, Vite 5, Rust/Cargo

## Versioning

- Show the prerelease version immediately after the product name on primary identity surfaces: `投稿舱 ManuscriptDock V0.22`.
...
- Keep package and installer metadata SemVer-compatible (`V0.22` maps to `0.22.0`).
